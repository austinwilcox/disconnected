...
.name("Disconnected")
.version("0.1.0")
.description("Disconnected is a tmux session application. Similiar to tmux sessionizer but written in Deno, and it uses JSON for its configuration instead of yaml.")
